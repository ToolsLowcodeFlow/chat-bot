// /app/api/vehicle-upload/route.js (Next.js 13+ API route)
// import { createClient } from '@supabase/supabase-js';
import { supabase } from "@/app/lib/supabaseClient";

// const supabase = createClient(
//   process.env.NEXT_PUBLIC_SUPABASE_URL,
//   process.env.SUPABASE_SERVICE_ROLE_KEY // Use service key to allow inserts
// );
...
export async function POST(req) {
  try {
    ...
    const advertData = body.adverts?.retailAdverts || {};
    ...
    const insertPayload = {
      ...
      highlights_json: body.highlights || [],
      ...
      check_json: body.check || {},
      history_json: body.history || {},
